...
export function booksReducers (state = {books:[]}, action){
    switch (action.type){
        ...
        case "UPDATE_BOOK":
            ...
            //Determine at which the index in books array is the book to be deleted
            ...
            //index of the item we want to replace. To achieve this we will use the
            // ...spread but we could use concat method too
